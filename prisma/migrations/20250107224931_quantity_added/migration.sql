...
INSERT INTO "new_Tickets" ("createdAt", "event_id", "event_time_id", "identification_num", "identification_type", "location", "payer_email", "payer_firstName", "payer_id", "payer_lastName", "price_per_ticket", "purchaser_id", "seat_location", "ticket_id", "updatedAt") SELECT "createdAt", "event_id", "event_time_id", "identification_num", "identification_type", "location", "payer_email", "payer_firstName", "payer_id", "payer_lastName", "price_per_ticket", "purchaser_id", "seat_location", "ticket_id", "updatedAt" FROM "Tickets";
DROP TABLE "Tickets";
